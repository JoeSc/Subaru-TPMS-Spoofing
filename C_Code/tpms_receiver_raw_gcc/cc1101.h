...
#define CC1101_DEFVAL_MCSM0      0x10        // Main Radio Control State Machine Configuration
...
//NOLD    /**
//NOLD     * High-gain mode enabled on the LD-board
//NOLD     */
//NOLD    bool hgmEnabled;
//NOLD
//NOLD    /**
//NOLD     * enablePA
//NOLD     *
//NOLD     * Enable PA and disable LNA on the LD-Board
//NOLD     */
//NOLD     void enablePA(void);
//NOLD
//NOLD    /**
//NOLD     * enableLNA
//NOLD     *
//NOLD     * Enable LNA and disable PA on the LD-Board
//NOLD     */
//NOLD     void enableLNA(void);
//NOLD
//NOLD    /**
//NOLD     * disableLNA
//NOLD     *
//NOLD     * Disable LNA and PA on the LD-Board
//NOLD     */
//NOLD     void disableLNA(void);
